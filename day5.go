...
var atLeast3Vowels *regexp.Regexp
var invalidStrings *regexp.Regexp

func containsSameRuneTwice(input string) bool {
	// Check for string with length less than 2 runes.
...
func isNiceString(input string) bool {
	return atLeast3Vowels.MatchString(input) &&
		containsSameRuneTwice(input) &&
